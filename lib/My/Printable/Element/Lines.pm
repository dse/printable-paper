...
sub draw {
    ...
    if ($self->direction eq "horizontal") {
        my $x1 = $self->x1 // $self->leftMarginX // $self->document->leftMarginX;
        my $x2 = $self->x2 // $self->rightMarginX // $self->document->rightMarginX;
        ...
        my $y1 = $self->y1 // $self->topMarginY // $self->document->topMarginY;
        my $y2 = $self->y2 // $self->bottomMarginY // $self->document->bottomMarginY;
